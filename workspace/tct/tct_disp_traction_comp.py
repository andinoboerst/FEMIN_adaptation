...
from tct.tct_disp_comp import TCTApplyFixedDisp

from shared.progress_bar import progressbar
from shared.plotting import format_vectors_from_flat


def tct_traction_comp(extractor: TCTExtractDisp, applicator: TCTApplyFixedDisp) -> None:
    ...
    for step in progressbar(range(tct_real.num_steps)):
        ...
        tct_pred.data_out[tct_pred.step, :] = tct_pred.calculate_interface_tractions()
...
if __name__ == "__main__":
    tct_real, tct_pred, prediction_error, bottom_half_nodes_real, bottom_half_nodes_pred = tct_traction_comp(TCTExtractDisp, TCTApplyFixedDisp)
